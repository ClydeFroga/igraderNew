...
<head>
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url')?>/style.css?version=1.25">
	<link rel="stylesheet" href="<?php bloginfo('template_url')?>/styles/swiper.css?version=3">
    ...
    <?php if(is_tax('mainthemes',1607) || is_tag(2099)) get_template_part('includes/ggladsense'); ?>
	<?php wp_head();?>
</head>
